...
fun Route.GiftMessageGuestItemRepositoryV1Api() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.getV1GuestcartsCartIdGiftmessageItemId> {  _: Paths.getV1GuestcartsCartIdGiftmessageItemId ->
...
when(exampleContentType) {
    ...
    route("/V1/guest-carts/{cartId}/gift-message/{itemId}") {
        post {
