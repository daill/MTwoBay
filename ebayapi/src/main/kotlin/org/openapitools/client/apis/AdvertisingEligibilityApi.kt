...
import org.openapitools.client.models.SellerEligibilityMultiProgramResponse
...
class AdvertisingEligibilityApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun getAdvertisingEligibility(X_EBAY_C_MARKETPLACE_ID: kotlin.String, programTypes: kotlin.String?) : SellerEligibilityMultiProgramResponse {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (programTypes != null) {
                    put("program_types", listOf(programTypes.toString()))
                }
            }
        ...
        val localVarResponse = request<SellerEligibilityMultiProgramResponse>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as SellerEligibilityMultiProgramResponse
