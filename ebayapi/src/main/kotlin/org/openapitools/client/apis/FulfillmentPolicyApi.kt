...
import org.openapitools.client.models.FulfillmentPolicyRequest
import org.openapitools.client.models.FulfillmentPolicyResponse
import org.openapitools.client.models.SetFulfillmentPolicyResponse
...
class FulfillmentPolicyApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun createFulfillmentPolicy(fulfillmentPolicyRequest: FulfillmentPolicyRequest) : SetFulfillmentPolicyResponse {
        ...
        val localVarResponse = request<SetFulfillmentPolicyResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getFulfillmentPolicies(marketplaceId: kotlin.String) : FulfillmentPolicyResponse {
        ...
        val localVarResponse = request<FulfillmentPolicyResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getFulfillmentPolicy(fulfillmentPolicyId: kotlin.String) : FulfillmentPolicy {
        ...
        val localVarResponse = request<FulfillmentPolicy>(
            localVariableConfig,
            localVariableBody
        )
    ...
    * @param fulfillmentPolicyRequest Fulfillment policy request 
    * @return SetFulfillmentPolicyResponse
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
