 ...
 * @param paymentPolicies A list of all of the seller's payment business policies defined for the specified marketplace. This array will be returned as empty if no payment business policies are defined for the specified marketplace.
 * @param prev This field is for future use.
 * @param total The total number of payment business policies retrieved in the result set.  <br/><br/>If no payment business policies are defined for the specified marketplace, this field is returned with a value of <code>0</code>.
 */
...
data class PaymentPolicyResponse (
    ...
    @Json(name = "paymentPolicies")
    val paymentPolicies: kotlin.collections.List<PaymentPolicy>? = null,
    /* This field is for future use. */
    @Json(name = "prev")
