...
import org.openapitools.client.models.BulkEbayOfferDetailsWithKeys
import org.openapitools.client.models.BulkOffer
import org.openapitools.client.models.BulkOfferResponse
import org.openapitools.client.models.BulkPublishResponse
import org.openapitools.client.models.EbayOfferDetailsWithAll
import org.openapitools.client.models.EbayOfferDetailsWithId
import org.openapitools.client.models.EbayOfferDetailsWithKeys
import org.openapitools.client.models.FeesSummaryResponse
import org.openapitools.client.models.OfferKeysWithId
import org.openapitools.client.models.OfferResponse
import org.openapitools.client.models.Offers
import org.openapitools.client.models.PublishByInventoryItemGroupRequest
import org.openapitools.client.models.PublishResponse
import org.openapitools.client.models.WithdrawByInventoryItemGroupRequest
import org.openapitools.client.models.WithdrawResponse
...
class OfferApi(basePath: kotlin.String = defaultBasePath, token: String) : ApiClient(basePath, token) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun bulkCreateOffer(body: BulkEbayOfferDetailsWithKeys) : BulkOfferResponse {
        ...
        val localVarResponse = request<BulkOfferResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    * @param body The base request of the &lt;strong&gt;bulkPublishOffer&lt;/strong&gt; method. 
    ...
    */
    ...
    fun bulkPublishOffer(body: BulkOffer) : BulkPublishResponse {
        ...
        val localVarResponse = request<BulkPublishResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun createOffer(contentLanguage: kotlin.String, body: EbayOfferDetailsWithKeys) : OfferResponse {
        ...
        val localVarResponse = request<OfferResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getListingFees(body: OfferKeysWithId?) : FeesSummaryResponse {
        ...
        val localVarResponse = request<FeesSummaryResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getOffer(offerId: kotlin.String) : EbayOfferDetailsWithAll {
        ...
        val localVarResponse = request<EbayOfferDetailsWithAll>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getOffers(format: kotlin.String?, limit: kotlin.String?, marketplaceId: kotlin.String?, offset: kotlin.String?, sku: kotlin.String?) : Offers {
        ...
        val localVarResponse = request<Offers>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun publishOffer(offerId: kotlin.String) : PublishResponse {
        ...
        val localVarResponse = request<PublishResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    * @param body The identifier of the inventory item group to publish and the eBay marketplace where the listing will be published is needed in the request payload. 
    * @return PublishResponse
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    ...
    */
    ...
    fun withdrawOffer(offerId: kotlin.String) : WithdrawResponse {
        ...
        val localVarResponse = request<WithdrawResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    * @param body The base request of the &lt;strong&gt;withdrawOfferByInventoryItemGroup&lt;/strong&gt; call. 
    * @return void
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
