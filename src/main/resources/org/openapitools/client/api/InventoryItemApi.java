...
public class InventoryItemApi {
    ...
    public InventoryItemApi(ApiClient apiClient) {
     ...
     * @param bulkInventoryItem Details of the inventories with sku and locale (required)
    ...
    private okhttp3.Call bulkCreateOrReplaceInventoryItemValidateBeforeCall(BulkInventoryItem bulkInventoryItem, final ApiCallback _callback) throws ApiException {
        ...
        if (bulkInventoryItem == null) {
            throw new ApiException("Missing the required parameter 'bulkInventoryItem' when calling bulkCreateOrReplaceInventoryItem(Async)");
        }
     ...
     * @param bulkGetInventoryItem Details of the inventories with sku and locale (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call bulkGetInventoryItemValidateBeforeCall(BulkGetInventoryItem bulkGetInventoryItem, final ApiCallback _callback) throws ApiException {
        ...
        if (bulkGetInventoryItem == null) {
            throw new ApiException("Missing the required parameter 'bulkGetInventoryItem' when calling bulkGetInventoryItem(Async)");
        }
     ...
     * @param bulkPriceQuantity Price and allocation details for the given SKU and Marketplace (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call bulkUpdatePriceQuantityValidateBeforeCall(BulkPriceQuantity bulkPriceQuantity, final ApiCallback _callback) throws ApiException {
        ...
        if (bulkPriceQuantity == null) {
            throw new ApiException("Missing the required parameter 'bulkPriceQuantity' when calling bulkUpdatePriceQuantity(Async)");
        }
     ...
     * @param inventoryItem Details of the inventory item record. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call createOrReplaceInventoryItemCall(String contentLanguage, String sku, InventoryItem inventoryItem, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createOrReplaceInventoryItemValidateBeforeCall(String contentLanguage, String sku, InventoryItem inventoryItem, final ApiCallback _callback) throws ApiException {
        ...
        if (inventoryItem == null) {
            throw new ApiException("Missing the required parameter 'inventoryItem' when calling createOrReplaceInventoryItem(Async)");
        }
        

        okhttp3.Call localVarCall = createOrReplaceInventoryItemCall(contentLanguage, sku, inventoryItem, _callback);
        return localVarCall;
     ...
     */
    public BaseResponse createOrReplaceInventoryItem(String contentLanguage, String sku, InventoryItem inventoryItem) throws ApiException {
        ApiResponse<BaseResponse> localVarResp = createOrReplaceInventoryItemWithHttpInfo(contentLanguage, sku, inventoryItem);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BaseResponse> createOrReplaceInventoryItemWithHttpInfo(String contentLanguage, String sku, InventoryItem inventoryItem) throws ApiException {
        okhttp3.Call localVarCall = createOrReplaceInventoryItemValidateBeforeCall(contentLanguage, sku, inventoryItem, null);
     ...
     */
    public okhttp3.Call createOrReplaceInventoryItemAsync(String contentLanguage, String sku, InventoryItem inventoryItem, final ApiCallback<BaseResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createOrReplaceInventoryItemValidateBeforeCall(contentLanguage, sku, inventoryItem, _callback);
        Type localVarReturnType = new TypeToken<BaseResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public void deleteInventoryItem(String sku) throws ApiException {
        deleteInventoryItemWithHttpInfo(sku);
    }
     ...
     */
    public ApiResponse<Void> deleteInventoryItemWithHttpInfo(String sku) throws ApiException {
     ...
     */
    public okhttp3.Call deleteInventoryItemAsync(String sku, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public ApiResponse<InventoryItemWithSkuLocaleGroupid> getInventoryItemWithHttpInfo(String sku) throws ApiException {
