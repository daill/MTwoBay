...
import org.openapitools.client.model.InventoryItemGroup;
...
public class InventoryItemGroupApi {
    private ApiClient localVarApiClient;

    public InventoryItemGroupApi() {
        this(Configuration.getDefaultApiClient());
    }

    public InventoryItemGroupApi(ApiClient apiClient) {
     ...
     * @param inventoryItemGroup Details of the inventory Item Group (required)
     ...
     */
    public okhttp3.Call createOrReplaceInventoryItemGroupCall(String contentLanguage, String inventoryItemGroupKey, InventoryItemGroup inventoryItemGroup, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createOrReplaceInventoryItemGroupValidateBeforeCall(String contentLanguage, String inventoryItemGroupKey, InventoryItemGroup inventoryItemGroup, final ApiCallback _callback) throws ApiException {
        ...
        if (inventoryItemGroup == null) {
            throw new ApiException("Missing the required parameter 'inventoryItemGroup' when calling createOrReplaceInventoryItemGroup(Async)");
        }
        

        okhttp3.Call localVarCall = createOrReplaceInventoryItemGroupCall(contentLanguage, inventoryItemGroupKey, inventoryItemGroup, _callback);
        return localVarCall;
     ...
     */
    public BaseResponse createOrReplaceInventoryItemGroup(String contentLanguage, String inventoryItemGroupKey, InventoryItemGroup inventoryItemGroup) throws ApiException {
        ApiResponse<BaseResponse> localVarResp = createOrReplaceInventoryItemGroupWithHttpInfo(contentLanguage, inventoryItemGroupKey, inventoryItemGroup);
     ...
     */
    public ApiResponse<BaseResponse> createOrReplaceInventoryItemGroupWithHttpInfo(String contentLanguage, String inventoryItemGroupKey, InventoryItemGroup inventoryItemGroup) throws ApiException {
        okhttp3.Call localVarCall = createOrReplaceInventoryItemGroupValidateBeforeCall(contentLanguage, inventoryItemGroupKey, inventoryItemGroup, null);
     ...
     */
    public okhttp3.Call createOrReplaceInventoryItemGroupAsync(String contentLanguage, String inventoryItemGroupKey, InventoryItemGroup inventoryItemGroup, final ApiCallback<BaseResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createOrReplaceInventoryItemGroupValidateBeforeCall(contentLanguage, inventoryItemGroupKey, inventoryItemGroup, _callback);
        Type localVarReturnType = new TypeToken<BaseResponse>(){}.getType();
     ...
     */
    public void deleteInventoryItemGroup(String inventoryItemGroupKey) throws ApiException {
        deleteInventoryItemGroupWithHttpInfo(inventoryItemGroupKey);
    }
     ...
     */
    public ApiResponse<Void> deleteInventoryItemGroupWithHttpInfo(String inventoryItemGroupKey) throws ApiException {
     ...
     */
    public okhttp3.Call deleteInventoryItemGroupAsync(String inventoryItemGroupKey, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public ApiResponse<InventoryItemGroup> getInventoryItemGroupWithHttpInfo(String inventoryItemGroupKey) throws ApiException {
