...
import org.openapitools.client.model.BulkMigrateListing;
import org.openapitools.client.model.BulkMigrateListingResponse;
...
public class ListingApi {
     ...
     * @param bulkMigrateListing Details of the listings that needs to be migrated into Inventory (required)
    ...
    private okhttp3.Call bulkMigrateListingValidateBeforeCall(BulkMigrateListing bulkMigrateListing, final ApiCallback _callback) throws ApiException {
        ...
        if (bulkMigrateListing == null) {
            throw new ApiException("Missing the required parameter 'bulkMigrateListing' when calling bulkMigrateListing(Async)");
        }
